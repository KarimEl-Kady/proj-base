...
Version tags (`v*`) build and publish an immutable image to GitHub Container
Registry through `.github/workflows/release-image.yml`. GitLab tag pipelines
publish the same Dockerfile to the GitLab Container Registry.
